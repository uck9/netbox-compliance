"""
Adapted from https://github.com/auroraresearchlab/netbox-dns/blob/main/netbox_dns/tests/custom.py
-- makes NetBox's test utilities work correctly for plugin-namespaced views/APIs.
"""
