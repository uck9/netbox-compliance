...
class PackageAssignmentTable(NetBoxTable):
    ...
    tenants = tables.ManyToManyColumn(linkify_item=True, verbose_name='Tenants (narrowed)')
    ...
    class Meta(NetBoxTable.Meta):
        ...
        fields = (
            ...
            'platform', 'tag', 'tenants', 'description', 'tags', 'created', 'last_updated', 'actions',
        )
        default_columns = ('pk', 'package', 'device', 'device_role', 'site', 'site_group', 'platform', 'tag', 'tenants')
